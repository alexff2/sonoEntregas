...
*Produto desenvolvido com React e Electron.*
<br>
...
```
git clone https://github.com/alexsanva/sonoentregas.git <your-project-name>
```
...
## Pendencias
1 - Travar rotas não listadas para futuro projeto web
2 - Opcao de arquivar usuário
3 - WebSocker
4 - Aprimorar para enviar produto entregue

### Contributors
@alexsanva | https://github.com/alexsanva
