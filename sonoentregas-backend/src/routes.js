...
routes.get('/reports/available-products-for-stores', reportsController.availableProductsForStores)
routes.get('/reports/beep-stock', reportsController.beepStock)
...
// Goals
routes.get('/goals', goalsController.findByYear)
