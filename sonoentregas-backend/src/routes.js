...
routes.put('/forecast/:idForecast/sale/:id/invalidation/auth', ensureAuthenticated, forecastValidationController.authInvalidation)
...
routes.put('/deliverys/:id', ensureAuthenticated, deliverysController.updateHeader)
routes.delete('/deliverys/:id', ensureAuthenticated, deliverysController.delete)
routes.put('/deliverys/status/:id', ensureAuthenticated, deliverysController.updateStatus)
//Homes
