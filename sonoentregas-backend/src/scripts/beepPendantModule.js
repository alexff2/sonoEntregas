...
SELECT * FROM (
  ...
  WHERE C.EMISSAO >= '2025-03-12' AND C.TIPODC = 'D'
  AND (A.QTD - ISNULL(B.QTD_BEEP, 0)) <> 0
  UNION
  ...
  INNER JOIN ${process.env.CD_BASE}..TRANSPRODLOJA C ON A.REGISTRO= C.CODIGO
  WHERE C.EMISSAO >= '2025-03-12' AND C.TIPODC = 'C'
  AND (A.QTD - ISNULL(B.QTD_BEEP, 0)) <> 0
  UNION
  ...
  FROM (
    ...
    FROM MAINTENANCE A
    INNER JOIN MAINTENANCE_DELIV B ON A.ID = B.ID_MAINT
    WHERE B.D_MOUNTING >= '2025-03-12' AND B.DONE = 0
