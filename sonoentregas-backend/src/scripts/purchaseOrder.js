module.exports = {
  ...
  findPurchaseOrderToReport() {
    return `
    SELECT A.CODIGOPEDIDO, C.NOME NOME_FOR, A.EMISSAO, A.VALORBRUTO, D.VALOR_CHEGADA, A.VALORBRUTO - D.VALOR_CHEGADA VL_REST, A.FACTORY_DATA,
    A.OBSERVACAO OBS
    FROM PEDFOR A
    ...
    AND A.TIPOFRETE = 'CIF' AND A.CFOP = 0
