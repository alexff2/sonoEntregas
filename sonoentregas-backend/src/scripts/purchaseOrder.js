...
module.exports = {
  ...
  findPurchaseOrderToReport() {
    return `
    SELECT A.CODIGOPEDIDO, C.NOME NOME_FOR, A.EMISSAO, DATEDIFF(DAY, A.EMISSAO, GETDATE()) DIAS_EMIS, A.VALORBRUTO, D.VALOR_CHEGADA, ROUND(A.VALORBRUTO - D.VALOR_CHEGADA, 2) difValue, A.FACTORY_DATA, A.OBSERVACAO OBS
    FROM PEDFOR A
