...
/****** Object:  View [dbo].[VIEW_MAINTENANCE]    Script Date: 05/16/2022 11:10:27 ******/
SET ANSI_NULLS ON
GO
...
SELECT A.*, D.UNITARIO1, C.NOMECLI, D.DESCRICAO PRODUTO, I.DESC_ABREV, B.ID_DELIV_MAIN ID_DELIV_MAINT, B.ID ID_MAINT_DELIV,
C.ENDERECO, C.BAIRRO, C.CIDADE, C.ESTADO, C.CGC_CPF, G.DESCRIPTION AS USERS, H.DESCRIPTION VISITANT, C.EMISSAO,
E.DESCRIPTION CAT_DEFECT, C.FONE, F.DATE_PREV, F.HOURS_PREV, F.DATE DATE_VISIT, F.TO_CD, F.CHANGE_PROD, F.OBS OBS_VISIT
FROM MAINTENANCE A
