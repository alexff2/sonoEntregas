...
/****** Object:  View [dbo].[VIEW_MAINTENANCE]    Script Date: 05/13/2022 16:55:42 ******/
SET ANSI_NULLS ON
GO
...
(C.ENDERECO+ ', ' + C.BAIRRO+ ', ' + C.CIDADE + '/' + C.ESTADO) ENDE, G.DESCRIPTION AS USERS, H.DESCRIPTION VISITANT,
